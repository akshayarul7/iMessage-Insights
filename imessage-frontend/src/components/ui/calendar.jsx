...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar bg-background p-4 [--cell-radius:var(--radius-md)] [--cell-size:2.5rem] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
      ...
      classNames={{
        ...
        weekdays: cn("flex w-full justify-between gap-2", defaultClassNames.weekdays),
        weekday: cn(
